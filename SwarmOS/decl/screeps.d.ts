...
interface Creep extends RoomObject {
     ...
     */
    memory: ScreepsObject_CreepMemory;
    /**
...
interface Flag extends RoomObject {
     ...
     */
    memory: ScreepsObject_FlagMemory;
    /**
     * Flag’s name.
     *
...
interface Game {
     ...
     */
    getObjectById<T extends ObjectTypeWithID>(id: string | undefined): T | undefined; // POTENTIAL ISSUE INTRODUCED BECAUSE THIS ACTUALLY RETURNS NULL
    /**
...
interface Room {
     ...
     */
    memory: ScreepsObject_RoomMemory;
    /**
...
interface StructureSpawn extends OwnedStructure<STRUCTURE_SPAWN> {
     ...
     */
    memory: ScreepsObject_SpawnMemory;
    /**
     ...
     * ```
     */
    createCreep(body: BodyPartConstant[], name?: string, memory?: ScreepsObject_CreepMemory): ScreepsReturnCode | string;
     ...
     * @param {{memory?: ScreepsObject_CreepMemory; energyStructures?: (StructureSpawn | StructureExtension)[]; dryRun?: boolean}} opts An object with additional options for the spawning process.
     ...
     * ```
     */
    spawnCreep(body: BodyPartConstant[], name: string, opts?: { memory?: ScreepsObject_CreepMemory, energyStructures?: Array<(StructureSpawn | StructureExtension)>, dryRun?: boolean }): ScreepsReturnCode;
