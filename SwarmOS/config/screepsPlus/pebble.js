...
function send_to_pebble() {
    ...
    if (numEnemies > 0) {
        lastEnemy = Game.time;
        lastEnemyTime = new Date().toLocaleTimeString('en-US', { timeZone: 'America/New_York', hour: '2-digit', minute: '2-digit' });
    ...
    Memory.pebble = {
        vibrate: 0,
        0: { progress: gclPct, bold: false, blink: false, bgColor: "#00007F", bgSecondColor: null, textColor: "#FFFFFF", textSecondColor: null, text: gclText },
        1: { progress: rclPct, bold: false, blink: false, bgColor: rclColor, bgSecondColor: null, textColor: "#FFFFFF", textSecondColor: null, text: rclText },
        2: { progress: enemyProgress, bold: false, blink: enemyBlink, bgColor: enemyColor, bgSecondColor: enemyColor2, textColor: "#FFFFFF", textSecondColor: null, text: enemyText },
        ...
        3: { progress: 0, bold: false, blink: false, bgColor: '#000000', bgSecondColor: null, textColor: "#CCCCCC", textSecondColor: null, text: "" },
    };
} // send_to_pebble
