...
export class SwarmSite extends OwnableSwarmObject<ConstructionSite, SwarmType.SwarmSite, RoomObjectMemory> implements ISwarmSite, ConstructionSite {
...
export function MakeSwarmSite(site: ConstructionSite, memory: RoomObjectMemory): TSwarmSite { return new SwarmSite(site, memory); }