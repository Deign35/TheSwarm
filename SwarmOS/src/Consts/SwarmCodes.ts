...
export const E_NOT_IMPLEMENTED = -6; declare type E_NOT_IMPLEMENTED = -6;

export type SwarmErrors = C_NONE | E_INVALID | E_MISSING_TARGET | E_REQUIRES_ENERGY | E_TARGET_INELLIGIBLE | E_ACTION_UNNECESSARY | E_NOT_IMPLEMENTED;