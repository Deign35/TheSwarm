...
interface StructureSpawn extends OwnedStructure<STRUCTURE_SPAWN> {
     ...
     * ```
     */
    spawnCreep(body: BodyPartConstant[], name: string, opts?: { memory?: any, energyStructures?: Array<(StructureSpawn | StructureExtension)>, dryRun?: boolean, directions?: DirectionConstant[] }): ScreepsReturnCode;
 ...
 */
interface StructurePowerBank extends Structure<STRUCTURE_POWER_BANK> {
