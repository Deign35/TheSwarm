...
export class DistributionConsul extends CreepConsul {
    ...
    InitJobRequirements() {
        super.InitJobRequirements();
        let spawnRefillerJob = this.CreateDefaultJobTemplate(this.consulType + '_Prime0');
        spawnRefillerJob.priority = SwarmConsts.SpawnPriority.Highest;
        spawnRefillerJob.supplementalData = SPAWN_REFILLER;
        this.AddNewJob(spawnRefillerJob);
    }
